...
export const Question = ({ text }: QuestionProps) => {
  ...
  return (
    <section
      className={`relative min-h-screen min-w-screen flex items-center justify-center bg-[url(/backgrounds/ferns-1.webp)] bg-green-800 bg-cover snap-center text-white text-9xl font-bold `}
    >
